              ...
              children: [
                ...
                const Row(
                  ...
                  children: [
                    IconButton(
                      icon: Icon(Icons
                          .alarm), // Utilizando FontAwesome5Solid como ejemplo
                      onPressed: null,
                    ),
                    IconButton(
                      icon: Icon(Icons
                          .key), // Utilizando FontAwesome5Solid como ejemplo
                      onPressed: null,
                    ),
                    IconButton(
                      icon: Icon(Icons
                          .camera_alt), // Utilizando FontAwesome5Solid como ejemplo
                      onPressed: null,
                    ),
                  ],
                ),
